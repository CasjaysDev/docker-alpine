# Docker image for docker-alpine using the scratch template
ARG LICENSE="MIT"
...
LABEL org.opencontainers.image.url="https://hub.docker.com/r/casjaysdev/${IMAGE_NAME}"
LABEL org.opencontainers.image.vcs-url="https://github.com/casjaysdev/${IMAGE_NAME}"
LABEL org.opencontainers.image.url.source="https://github.com/casjaysdev/${IMAGE_NAME}"
LABEL org.opencontainers.image.documentation="https://hub.docker.com/r/casjaysdev/${IMAGE_NAME}"
